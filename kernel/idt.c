...
void init_idt(void) {
    ...
    for (int v = 0; v < IDT_LEN; v++) {
        // idt[15] // RESERVED // idt[22-31] // RESERVED
        if (!IDT_RSVD_VECT(v))
            idt[v] = intr_gate_d ((uint32_t)idt_proc_entry_p[v], SEGMENT_PRESENT, DPL_0,
                                  GATE_SIZE_32_BITS, GDT_CODE_SEG);
    }
/*
    idt[1] = intr_gate_d (((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(1)),
                          SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS,
                          GDT_CODE_SEG);

    idt[2] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(2)) );
    idt[3] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(3)) );
    idt[4] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(4)) );
    idt[5] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(5)) );
    idt[6] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(6)) );
    idt[7] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(7)) );
    idt[8] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(8)) );
    idt[9] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(9)) );
    idt[10] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(10)) );
    idt[11] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(11)) );
    idt[12] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(12)) );
    idt[13] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(13)) );
    idt[14] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(14)) );
*/
    // idt[15] // RESERVED

/*
    idt[16] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(16)) );
    idt[17] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(17)) );
    idt[18] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(18)) );
    idt[19] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(19)) );
    idt[20] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(20)) );
    idt[21] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(21)) );
*/
    // idt[22-31] // RESERVED

/*
    idt[32] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(32)) );
    idt[33] = IDT_INTR_GATE_DESCRIPTOR(SEGMENT_PRESENT, DPL_0, GATE_SIZE_32_BITS, GDT_CODE_SEG, ((uint32_t)INTR_V_N_HANDLER_FUNC_NAME(33)) );
*/
    // Load IDT register
